...
type RateLimiter interface {
	...
	// Returns status details if blocked.
	AllowRequest(ctx context.Context, keyID, modelAlias string) (bool, domain.RateLimitStatus, error)
	...
	// Check performs a side-effect-free connectivity check to the cache backend.
